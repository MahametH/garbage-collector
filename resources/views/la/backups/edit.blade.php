...
@section("htmlheader_title", "Backups Edition : ".$backup->$view_col)
			...
			<div class="col-md-8 col-md-offset-2">
				{!! Form::model($backup, ['route' => [config('laraadmin.adminRoute') . '.backups.update', $backup->id ], 'method'=>'PUT', 'id' => 'backup-edit-form']) !!}
					...
					<div class="form-group">
						{!! Form::submit( 'Mettre à jour', ['class'=>'btn btn-success']) !!} <button class="btn btn-default pull-right"><a href="{{ url(config('laraadmin.adminRoute') . '/backups') }}">Annuler</a></button>
					</div>
				{!! Form::close() !!}
			</div>
		</div>
