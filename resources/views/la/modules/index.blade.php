...
@section("contentheader_description", "modules liste")
@section("section", "Modules")
@section("sub_section", "List")
@section("htmlheader_title", "Modules Liste")

@section("headerElems")
<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Ajouter Module</button>
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Ajouter Module</h4>
			</div>
			...
			<div class="modal-body">
				<div class="box-body">
					<div class="form-group">
						...
						{{ Form::text("name", null, ['class'=>'form-control', 'placeholder'=>'Nom du Module', 'data-rule-minlength' => 2, 'data-rule-maxlength'=>20, 'required' => 'required']) }}
					</div>
					<div class="form-group">
...
<div class="modal" id="module_delete_confirm">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Voulez-vous vraiment supprimer le module<b id="moduleNameStr" class="text-danger"></b> ?</p>
				<p>Les fichers suivants seront supprimés:</p>
			...
			<div class="modal-footer">
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.modules.destroy', 0], 'id' => 'module_del_form', 'method' => 'delete', 'style'=>'display:inline']) }}
					<button class="btn btn-danger btn-delete pull-left" type="submit">Oui</button>
				{{ Form::close() }}
				<a data-dismiss="modal" class="btn btn-default pull-right" >Non</a>				
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
