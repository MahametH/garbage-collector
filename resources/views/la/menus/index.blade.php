...
@section("contentheader_description", "Editeur")
@section("section", "Menus")
@section("sub_section", "Editeur")
@section("htmlheader_title", "Editeur de Menu")
			...
			<div class="col-md-4 col-lg-4">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab-custom-link" data-toggle="tab">Liens Personnalisés</a></li>
					</ul>
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-custom-link">
							...
							{!! Form::open(['action' => '\Dwij\Laraadmin\Controllers\MenuController@store', 'id' => 'menu-custom-form']) !!}
								...
								<div class="form-group">
									<label for="name" style="font-weight:normal;">Etiquette</label>
									<input class="form-control" placeholder="Etiquette" name="name" type="text" value=""  data-rule-minlength="1" required>
								</div>
								<div class="form-group">
									<label for="icon" style="font-weight:normal;">Icône</label>
								...
								<input type="submit" class="btn btn-primary pull-right mr10" value="Ajouter au menu">
							{!! Form::close() !!}
						</div>
					</div><!-- /.tab-content -->
				</div><!-- nav-tabs-custom -->
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Editer Element du Menu</h4>
			</div>
