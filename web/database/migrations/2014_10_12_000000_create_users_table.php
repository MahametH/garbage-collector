...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Users", 'users', 'name', 'fa-group', [
            ["name", "Nom", "Name", false, "", 5, 250, true],
            ["email", "Email", "Email", true, "", 0, 250, false],
            ["password", "Mot de passe", "Password", false, "", 6, 250, true],
            ["type", "Type d'Utilisateur", "Dropdown", false, "Agent", 0, 0, true, ["Administrateur","Agent"]],
        ]);
